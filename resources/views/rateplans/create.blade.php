    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="container-fluid">
                ...
                <div class="bg-gradient-success text-white p-4 rounded-top">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-0 fw-bold">
                                <i class="fas fa-plus-circle me-2"></i> Create New Rate Plan
                            </h3>
                            <p class="mb-0 opacity-75">Add pricing plan for tour packages</p>
                        </div>
                        <a href="{{ route('rateplans.index') }}" class="btn btn-light shadow">
                            <i class="fas fa-arrow-left me-2"></i> Back to Rate Plans
                        </a>
                    </div>
                </div>
                ...
                <div class="p-4">
                    ...
                    <form action="{{ route('rateplans.store') }}" method="post" class="needs-validation">
                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select class="form-select @error('board_type') is-invalid @enderror"
                                                    ...
                                                    <option value="All Inclusive" {{ old('board_type') == 'All Inclusive' ? 'selected' : '' }}>All Inclusive</option>
                                                    <option value="Half Board" {{ old('board_type') == 'Half Board' ? 'selected' : '' }}>Half Board</option>
                                                    <option value="Full Board" {{ old('board_type') == 'Full Board' ? 'selected' : '' }}>Full Board</option>
                                                    <option value="Bed & Breakfast" {{ old('board_type') == 'Bed & Breakfast' ? 'selected' : '' }}>Bed & Breakfast</option>
                                                </select>
                                                @error('board_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select class="form-select @error('transportation') is-invalid @enderror"
                                                    ...
                                                    <option value="No transfers" {{ old('transportation') == 'No transfers' ? 'selected' : '' }}>No transfers</option>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('details.en') is-invalid @enderror"
                                            ...
                                            placeholder="Enter plan details in English">{{ old('details.en') }}</textarea>
                                        @error('details.en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('details.de') is-invalid @enderror"
                                            ...
                                            placeholder="Geben Sie die Details des Plans auf Deutsch ein">{{ old('details.de') }}</textarea>
                                        @error('details.de')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('details.fr') is-invalid @enderror"
                                            ...
                                            placeholder="Entrez les détails du plan en français">{{ old('details.fr') }}</textarea>
                                        @error('details.fr')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success btn-lg px-5 py-3 shadow">
                                <i class="fas fa-save me-2"></i> Create Rate Plan
                            </button>
                        </div>
                    </form>
                </div>
